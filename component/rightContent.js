export function rightContent() {
    ...
    div.setAttribute('id', 'rightContent')
    div.innerHTML = ` <div style="width: 100%;height: auto; border-radius: 7px;">
    <h5 style="padding: 15px 16px 0px 16px;">Key Series</h5>
    <hr>
...
<div style="width: 100%;height: auto; border-radius: 7px;">
    <h5 style="padding: 15px 16px 0px 16px;">Quick Links</h5>
    <hr>
    <div style="padding: 5px;">
...
<div style="width: 100%;height: auto; border-radius: 7px;">
    <h5 style="padding: 15px 16px 0px 16px;">ESPNcricinfo Apps</h5>
    <hr>
    <div style="padding: 5px;">
...
<div style="width: 100%;height: auto; border-radius: 7px;">
    <h5 style="padding: 15px 16px 0px 16px;">Follow ESPNcricinfo</h5>
    <hr>
    <div style="padding: 5px;">
...
<div style="width: 100%;height: auto; border-radius: 7px;">
    <h5 style="padding: 15px 16px 0px 16px;">ESPN Sites</h5>
    <hr>
    <div style="padding: 5px;">
